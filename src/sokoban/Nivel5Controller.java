...
public class Nivel5Controller implements Initializable {
    ...
    private final int Vcolumna[] = {1, 1, 1, 1, 1, 2, 3, 2, 2, 3, 4, 5, 6, 6, 7, 8, 9, 10, 9, 9, 8, 7, 7, 6, 5, 5, 5, 5, 5, 5, 4, 3, 2, 3};
    private final int Vfila[] = {9, 8, 7, 6, 5, 4, 4, 2, 1, 0, 0, 0, 1, 2, 1, 1, 2, 3, 4, 5, 6, 5, 4, 4, 4, 5, 6, 7, 8, 9, 10, 10, 10, 3};
    ...
    private final int[][] MovCaja3 = new int[1000][2];
    private final int[][] MovCaja4 = new int[1000][2];
    private final int[][] MovCaja5 = new int[1000][2];

    //cotador de restringir el deshacer a solo 3 veces por nivel amenos que vuelva 
    ...
    private void pressedNext(MouseEvent event) throws IOException {
        ...
        if (nextLeven == true) {
            try {
                ...
                //obtiene el controlador del la Scene del nivel 6
                ...
                if (pasos == 160) {
                    ...
                    dialogo.setContentText("FELICIDADES HA CONSEGUIDO EL LOGRO DE PASAR "
                            + " EL NIVEL CON EL MINIMO DE PASOS (160). EL CUAL"
                ...
                //muestra la scena del nivel 6 en una nueva ventana  
                Scene scene = new Scene(root);
                scene.getStylesheets().add("/css/CSS.css");
                stage.setScene(scene);
                stage.centerOnScreen();
...
////////caja4///////////////////////////////////////////////////////////////////
    ...
    private boolean BoxWithBox(int columnaBWB, int filaBWB, int NumeroCaja) {
        ...
        switch (NumeroCaja) {
            ...
            case 1:
                if (((columnaBWB == c2) && (filaBWB == f2)) || ((columnaBWB == c3) && (filaBWB == f3)) || ((columnaBWB == c4) && (filaBWB == f4)) || ((columnaBWB == c5) && (filaBWB == f5))) {
                    return false;
                }
                break;
            case 2:
                if (((columnaBWB == c1) && (filaBWB == f1)) || ((columnaBWB == c3) && (filaBWB == f3)) || ((columnaBWB == c4) && (filaBWB == f4)) || ((columnaBWB == c5) && (filaBWB == f5))) {
                    return false;
                }
                break;
            case 3:
                if (((columnaBWB == c1) && (filaBWB == f1)) || ((columnaBWB == c2) && (filaBWB == f2)) || ((columnaBWB == c4) && (filaBWB == f4)) || ((columnaBWB == c5) && (filaBWB == f5))) {
                    return false;
                }
                break;
            case 4:
                if (((columnaBWB == c1) && (filaBWB == f1)) || ((columnaBWB == c2) && (filaBWB == f2)) || ((columnaBWB == c3) && (filaBWB == f3)) || ((columnaBWB == c5) && (filaBWB == f5))) {
                    return false;
                }
                break;
            case 5:
    ...
    private void HabilitarBtnNext() throws FileNotFoundException {
        ...
        if (((c1 == cOb1) && (f1 == fOb1)) || ((c1 == cOb2) && (f1 == fOb2)) || ((c1 == cOb3) && (f1 == fOb3)) || ((c1 == cOb4) && (f1 == fOb4)) || ((c1 == cOb5) && (f1 == fOb5))) {
            c++;
            caja.setImage(verde);
        } else {
            caja.setImage(amarillo);
        }//#2
        if (((c2 == cOb1) && (f2 == fOb1)) || ((c2 == cOb2) && (f2 == fOb2)) || ((c2 == cOb3) && (f2 == fOb3)) || ((c2 == cOb4) && (f2 == fOb4)) || ((c2 == cOb5) && (f2 == fOb5))) {
            c++;
            caja1.setImage(verde);
        } else {
            caja1.setImage(amarillo);
        }//#3
        if (((c3 == cOb1) && (f3 == fOb1)) || ((c3 == cOb2) && (f3 == fOb2)) || ((c3 == cOb3) && (f3 == fOb3)) || ((c3 == cOb4) && (f3 == fOb4)) || ((c3 == cOb5) && (f3 == fOb5))) {
            c++;
            caja2.setImage(verde);
        } else {
            caja2.setImage(amarillo);
        }//#4
        if (((c4 == cOb1) && (f4 == fOb1)) || ((c4 == cOb2) && (f4 == fOb2)) || ((c4 == cOb3) && (f4 == fOb3)) || ((c4 == cOb4) && (f4 == fOb4)) || ((c4 == cOb5) && (f4 == fOb5))) {
            c++;
            caja3.setImage(verde);
        } else {
            caja3.setImage(amarillo);
        }//#5
        if (((c5 == cOb1) && (f5 == fOb1)) || ((c5 == cOb2) && (f5 == fOb2)) || ((c5 == cOb3) && (f5 == fOb3)) || ((c5 == cOb4) && (f5 == fOb4)) || ((c5 == cOb5) && (f5 == fOb5))) {
            c++;
    ...
    private void reiniciarAuto(int autoOusuario) throws MalformedURLException {
        ...
        GridPane.setColumnIndex(personaje, 2);
        GridPane.setRowIndex(personaje, 5);

        GridPane.setColumnIndex(caja, 3);
        GridPane.setRowIndex(caja, 5);

        GridPane.setColumnIndex(caja1, 3);
        GridPane.setRowIndex(caja1, 6);

        GridPane.setColumnIndex(caja2, 4);
        GridPane.setRowIndex(caja2, 6);

        GridPane.setColumnIndex(caja3, 3);
        GridPane.setRowIndex(caja3, 7);

        GridPane.setColumnIndex(caja4, 3);
        ...
        try {
            ...
            Logger.getLogger(Nivel5Controller.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    void DatosDeTransferencia(String nombre, int datos1, int datos2, int datos3, int datos4) {
    ...
    private void DEADLOCK() throws MalformedURLException {
        ...
        int cc[] = {3, 5, 4, 2, 2, 2, 2, 2, 3};
        int ff[] = {2, 1, 9, 9, 8, 7, 6, 5, 9};
